...
Capacity is the other problem. Modern signalling could allow many more trains to use the same tracks, potentially even 10x the present frequency. Before reaching for another megaproject, we should ask how much more Colombo
could get from the railway it already has.
